...
int main()
{
    ...
    while (input == '1') {
        ...
        cin >> student[i].uts;
        if (student[i].uts < 0 || student[i].uts > 50){
            cout << "Error. Try again by entering UTS value from 0-50"<<endl;
            continue;
        }
        cout << "Enter the UAS value:" << endl;
        cin >> student[i].uas;
        if (student[i].uas < 0 || student[i].uas > 50){
            cout << "Error. Try again by entering UTS value from 0-50"<<endl;
            continue;
        }
    ...
    cout << "------------------" << endl;
      ...
      cout << "Would you like to add more student" << endl;
      cin >> input;
    if (input != '1'){
        cout << "-------------" << endl;
